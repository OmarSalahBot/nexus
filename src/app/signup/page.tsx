...
export default function SignUpPage() {
  ...
  const strengthColor = ["", "bg-red-500", "bg-yellow-400", "bg-blue-400", "bg-green-500"][passwordStrength];
          ...
          <div className="w-full mt-15 max-w-lg">
            ...
            <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-8">
              ...
              <div className="mb-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Join Nexus and start connecting</p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-7 dark:placeholder:text-zinc-100  pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="••••••••"
                      className="w-full px-4 dark:placeholder:text-zinc-100 py-2.5 pr-11 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                    />
                    <button
                      type="button"
                        ...
                        {[1, 2, 3, 4].map((i) => (
                          <div
                            ...
                            className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                              i <= passwordStrength ? strengthColor : "bg-gray-200 dark:bg-white/10"
                            }`}
                          />
                        ))}
                      </div>
