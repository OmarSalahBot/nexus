...
export default function QuickLoginButton() {
  ...
  return (
    <button
      onClick={()=> handleLogin()}
      className="flex items-center absolute top-0 right-120 w-55  gap-3 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
    >
